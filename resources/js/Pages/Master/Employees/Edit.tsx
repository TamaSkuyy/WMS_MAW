...
export default function Edit({ employee, jobPositions, workLocations, departments, users }: any) {
    ...
    return (
        <AppLayout>
            ...
            <ComponentCard title="Edit Karyawan">
                <form onSubmit={(e) => { e.preventDefault(); put(route('employees.update', employee.id)); }} className="space-y-4 max-w-lg">
                    <div>
                        <Label>Nama *</Label>
