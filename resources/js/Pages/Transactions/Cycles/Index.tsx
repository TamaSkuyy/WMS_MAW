        ...
        <>
            ...
            <ComponentCard title="Daftar Cycle">
                    ...
                    <div className="w-full sm:min-w-[200px]">
                        ...
                        <SearchableSelect
                            ...
                            onChange={(v) =>
                                router.get(
                                    route("cycles.index"),
                                    { ...filters, supplier_id: v as string },
                ...
                <div className="mb-3 flex flex-wrap gap-2 items-center">
                    {canCreate && (
                        <Link href={route("cycles.create")}>
                            <Button>Tambah Cycle</Button>
                        </Link>
                    )}
                    {canCreate && (
                ...
                {canCreate && (
                    <ImportModal
                        ...
                        finishedActionLabel={
                            canReceive ? "🚚 Terima Barang Sekarang" : undefined
                        }
                ...
                {cycles.data.length === 0 ? (
                    <EmptyState
                        ...
                        actionRoute={
                            canCreate ? route("cycles.create") : undefined
                        }
                    />
                ) : (
                        ...
                        <table className="min-w-full">
                            <thead className="bg-[#F8F9FC] border-b border-[#E9ECEF]">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left text-[11px] font-semibold text-[#6C757D] uppercase tracking-wider w-24">
                                        Aksi
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                {cycles.data.map((cycle: any) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 whitespace-nowrap text-sm text-[#1A1D23] font-mono">
                                            #{cycle.cycle_number}
                                        </td>
                                        <td className="px-4 py-3 whitespace-nowrap">
                                            <span
                                                className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${statusColors[cycle.status] || ""}`}
                                            >
                                                {cycle.status}
                                            </span>
                                        </td>
